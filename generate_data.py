...
import csv
import numpy as np
FONTPATH = ["./data/font/Times-Bold.ttf", "./data/font/Courier_Bold.ttf"]
ENGSTR = "ABCDEFGHJKLMNPQRSTUVWXYZ" # 沒有O和I
LETTERSTR = "0123456789"#ABCDEFGHJKLMNPQRSTUVWXYZ"
...
if __name__ == "__main__":
    generate(10, "./data/5_imitate_train_set/",  ENGP=100, FIVEP=100, ENGNOLIMIT=True, filename="train")
    generate(2, "./data/5_imitate_vali_set/",  ENGP=100, FIVEP=100, ENGNOLIMIT=True, filename="vali")